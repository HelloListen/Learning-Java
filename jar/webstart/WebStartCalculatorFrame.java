...
import javax.swing.*;
/**
 * A frame with a calculator pancel and a menu to load and save the calculator history.
 */
public class WebStartCalculatorFrame extends JFrame{
    ...
    /**
     * Gets the title form the persistent store or asks the user for the title if there is no prior
     * enrty.
     */
    public void setTitle(){
        try{
            ...
            try{
                ...
                FileContents contents=service.get(key);
                OutputStream put=contents.getOutputStream(true);
    ...
    /**
     * Opens a history fiel and updates the display
     */
    public void open(){
        try{
