...
/**
 * This task enumerates all files in a firectory and its subdirectories.
 */
class FileEnumerationTask implements Runnable {
     ...
     */
    public FileEnumerationTask(BlockingQueue<File> queue, File startingDirectroy) {
        this.queue = queue;
        this.startingDirectory = startingDirectroy;
    }
